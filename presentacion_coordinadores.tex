...
\begin{frame}[plain]
  \begin{tikzpicture}[remember picture, overlay]
    ...
    \draw[uamred, line width=1.2pt]
      ($(current page.north west)+(0.6cm,-2.1cm)$) --
      ($(current page.north east)+(-0.6cm,-2.1cm)$);
    ...
    \node[anchor=north west, text=cardborder,
          ...
          inner sep=0pt]
      at ($(current page.north west)+(0.7cm,-3.5cm)$) {
    ...
    \node[anchor=north west, text=graymid,
          ...
          inner sep=0pt]
      at ($(current page.north west)+(0.7cm,-4.3cm)$) {
    ...
    \node[anchor=south west, text=cardborder,
      ...
      at ($(current page.south west)+(0.7cm,1.5cm)$) {
        Dr.\ César Simón López-Monsalvo · Depto.\ de Ciencias Básicas · junio 2026
    };
